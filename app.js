...
client.on('ready', () => {
    ...
    //client.user.setActivity('SketchUp', {type: 'Playing'});
});
...
//STUPID EASTER EGGS, SPECIFIC CASES
		...
		else if (message.content.match(/quote the lion king/i))
	{
		...
		else if (message.content.match(/why aren't the wheels transparent/i) || (message.content.match(/wheels/i) && (message.content.match(/transparent/i))
	{
